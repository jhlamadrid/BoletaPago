	...
	<div class="container">
		<div class="panel-group">
			<div class="panel panel-primary">
		      <div class="panel-heading"> <h4 style='color:#000;'> <strong> <span class="fa fa-file"> </span> DUPLICADO VIRTUAL DE RECIBO  <span style='color:#fff;'> (#YoMeQuedoEnCasa)</span> </strong> </h4> </div>
